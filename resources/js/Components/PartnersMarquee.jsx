        ...
        <section className="relative z-10 py-16 sm:py-20 border-y dark:border-white/10 border-slate-200 dark:bg-[#080D1A]/60 bg-slate-50/80 overflow-hidden pause-marquee transition-colors">
            ...
            <div className="flex w-max animate-marquee gap-6">
                {marqueeList.map((partner, index) => (
                    <div
                        key={index}
                        className="px-6 py-3.5 rounded-2xl dark:bg-[#111C38]/70 bg-white border dark:border-slate-800 border-slate-200/80 shadow-sm flex items-center gap-3 shrink-0 hover:border-[#00D084]/50 transition-colors group cursor-default"
                    >
                        <div className="w-8 h-8 rounded-xl dark:bg-[#080D1A] bg-slate-100 border dark:border-slate-700 border-slate-200 flex items-center justify-center font-display font-bold text-xs text-[#00D084] group-hover:border-[#00D084] transition-colors">
